...
export default function AdminPage() {
  ...
  // Close new SOP dropdown on outside click
  useEffect(() => {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="relative" ref={newMenuRef}>
          ...
          >
            ...
            New SOP
            <svg className={`w-3 h-3 transition-transform ${showNewMenu ? "rotate-180" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
